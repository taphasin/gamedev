...
jump = pygame.mixer.Sound("../Release/BGM/jump2.mp3")
coin = pygame.mixer.Sound("../Release/BGM/coin.wav")

gameDisplay = pygame.display.set_mode((display_width,display_height))
pygame.display.set_caption('dang dang')
clock   = pygame.time.Clock()

dangimg  = pygame.image.load("../Release/IMG/dangwithred.png")
dangimg  = pygame.transform.scale(dangimg, (20, 30))
barimg   = pygame.image.load("../Release/IMG/bar.png")
barimg   = pygame.transform.scale(barimg, (50, 5))
spikeimg = pygame.image.load("../Release/IMG/spike.png")
spikeimg = pygame.transform.scale(spikeimg, (21, 21))
starimg  = pygame.image.load("../Release/IMG/star.png")
...
largeText = pygame.font.Font('../Release/font/Minecraft.ttf',70)
menuText  = pygame.font.Font('../Release/font/Minecraft.ttf',50)
smallText = pygame.font.Font('../Release/font/Minecraft.ttf',40)
thinText  = pygame.font.Font('../Release/font/Minecraft.ttf',30)
...
def board():
    ...
    with open('../Release/scoredata.txt') as datafile:
...
def crash():
    ...
    pygame.mixer.music.load("../Release/BGM/miss.mp3")
...
def game_intro():
    pygame.mixer.music.pause()
    pygame.mixer.music.load("../Release/BGM/menu.mp3")
    pygame.mixer.music.play(-1)
    ychange = 1
    y = -50
    global input
...
def gameloop():
    ...
    pygame.mixer.music.pause()
    pygame.mixer.music.load("../Release/BGM/play.mp3")
    pygame.mixer.music.play(-1)
